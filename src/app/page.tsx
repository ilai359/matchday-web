            ...
            >
              ...
              <div className="relative z-10 p-6">
                ...
                <div className="mt-7 flex items-center justify-between gap-3 border-t border-white/10 pt-4">
                  ...
                  <button className="shrink-0 rounded-xl bg-white/10 px-3 py-2 text-xs font-bold text-white/80 transition hover:bg-white/15">
                    Details
                  </button>
                </div>
              </div>
            ...
            <div className="flex flex-col gap-3">
              {upcomingMatches.map((match) => {
                ...
                return (
                  <div
                    key={match.id}
                    className="relative overflow-hidden rounded-[22px] border border-black/[0.045] bg-white p-4 shadow-[0_5px_20px_rgba(0,0,0,0.035)] transition duration-200 hover:-translate-y-0.5 hover:shadow-[0_12px_30px_rgba(0,0,0,0.07)]"
                  >
                    <div
